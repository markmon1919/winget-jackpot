...
import json, logging, math, os, platform, pyautogui, random, re, redis, subprocess, sys, time, threading
    ...
    try:
        ...
        if not wheel_mode and not quick_spin:
            ...
            if not scatter_mode:
                ...
                if state.fast_mode and random.random() < 0.81:
        ...
        spin_type = "wheel_spin" if wheel_mode else "scatter_spin" if scatter_mode else random.choice(spin_types)
        ...
        if spin_type == "normal_spin":
            if state.widescreen:
                ...
                if "PP" in provider.get("initial"):
                    action.extend([
                        lambda: pyautogui.click(x=cx, y=BTM_Y - 200, button='left'),
                        # lambda: pyautogui.press('space'),
                        # lambda: (pyautogui.keyDown('space'), pyautogui.keyUp('space')),
                        lambda: (pyautogui.mouseDown(x=cx, y=BTM_Y - 200, button='left'), pyautogui.mouseUp(button='left'))
                    ])
                else:
                    ...
                    action.extend([
                        ...
                        # lambda: pyautogui.press('space'),
                        # lambda: (pyautogui.keyDown('space'), pyautogui.keyUp('space')),
                        lambda: (pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='left'), pyautogui.mouseUp(button='left')),
                        lambda: (pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='right'), pyautogui.mouseUp(button='right'))
            ...
            if state.widescreen:
                ...
                action.extend([
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='left'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(button='left')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='left'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(button='right')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='right'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(button='left')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='right'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(button='right')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='left'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='left')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='left'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='right')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='right'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='left')),
                    lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='right'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='right')),
                    lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='left')),
                    lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='right')),
                    lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='right')),
                    lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='left')),
                    lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='left')),
                    lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='right')),
                    lambda: (pyautogui.keyDown('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='left')),
                    lambda: (pyautogui.keyDown('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='right')),
                    lambda: (pyautogui.keyDown('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='left')),
                    lambda: (pyautogui.keyDown('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=rand_x, y=rand_y, button='right'))
                ]) if not state.spin_btn else \
                action.extend([
        ...
        #         ])
            ...
            if state.widescreen:
                ...
                action.extend([
                    ...
                    lambda: (pyautogui.click(x=rand_x, y=rand_y), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='left'), time.sleep(hold_delay), pyautogui.mouseUp(button='left')),
                    lambda: (pyautogui.click(x=rand_x, y=rand_y), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='right'), time.sleep(hold_delay), pyautogui.mouseUp(button='right'))
                ]) if not state.spin_btn else \
                action.extend([
                    lambda: (pyautogui.click(x=rand_x, y=rand_y, button='left'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(button='left'), time.sleep(hold_delay), pyautogui.mouseUp(button='left')),
        ...
        #         ])
            ...
            if state.widescreen:
                ...
                action.extend([
                    ...
                    # lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='left'), pyautogui.mouseDown(x=rand_x, y=rand_y, button='left'), pyautogui.moveTo(x=rand_x2, y=rand_y2), pyautogui.mouseUp()),                    
                    ...
                    lambda: (
                        pyautogui.click(x=cx, y=BTM_Y - 105, button='left'),
                        time.sleep(random.uniform(0.05, 0.12)),
                        (pyautogui.moveTo(x=rand_x, y=rand_y, duration=random.uniform(0.05, 0.12)) 
                            if random.random() < 0.7 else pyautogui.mouseDown(x=rand_x, y=rand_y, button='left')),
                        pyautogui.mouseDown(button='left') if random.random() < 0.7 else None,
                    ...
                    # lambda: (pyautogui.click(x=cx, y=BTM_Y - 105, button='left'), pyautogui.mouseDown(x=rand_x, y=rand_y, button='right'), pyautogui.moveTo(x=rand_x2, y=rand_y2, duration=0.3), pyautogui.mouseUp()),
                ...
                action.extend([
                    ...
                    lambda: (
                        pyautogui.click(x=cx, y=BTM_Y - 105, button='right'),
                        time.sleep(random.uniform(0.05, 0.12)),
                        (pyautogui.moveTo(x=rand_x, y=rand_y, duration=random.uniform(0.05, 0.12)) 
                            if random.random() < 0.7 else pyautogui.mouseDown(x=rand_x, y=rand_y, button='left')),
                        pyautogui.mouseDown(button='left') if random.random() < 0.7 else None,
            ...
            if provider.get("initial") == "JILI":
                action.extend([
                    ...
                    lambda: [ pyautogui.click(x=cx, y=BTM_Y - 105, clicks=6, interval=execution_time, button="left") for _ in range(3) ],
                    lambda: [ pyautogui.click(x=cx, y=BTM_Y - 105, clicks=6, interval=execution_time, button="right") for _ in range(3) ],
                    ...
                    lambda: [ pyautogui.doubleClick(x=cx, y=BTM_Y - 105, interval=execution_time, button="left") for _ in range(3) ],
                    lambda: [ pyautogui.doubleClick(x=cx, y=BTM_Y - 105, interval=execution_time, button="right") for _ in range(3) ],
                    ...
                    # lambda: pyautogui.doubleClick(x=cx, y=BTM_Y - 105, clicks=3, interval=execution_time, button="left"),
                    # lambda: pyautogui.doubleClick(x=cx, y=BTM_Y - 105, clicks=3, interval=execution_time, button="right"),
                    ...
                    lambda: [ (pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button="left"), pyautogui.typewrite(['space'] * 6, interval=execution_time), pyautogui.mouseUp(button='left')) for _ in range(3) ],
                    lambda: [ (pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button="right"), pyautogui.typewrite(['space'] * 6, interval=execution_time), pyautogui.mouseUp(button='right')) for _ in range(3) ],
                    ...
                    lambda: [ (pyautogui.keyDown('space'), pyautogui.click(x=cx, y=BTM_Y - 105, clicks=6, interval=execution_time, button="left"), pyautogui.keyUp('space')) for _ in range(3) ],
                    lambda: [ (pyautogui.keyDown('space'), pyautogui.click(x=cx, y=BTM_Y - 105, clicks=6, interval=execution_time, button="right"), pyautogui.keyUp('space')) for _ in range(3) ],
                    ...
                    lambda: [ (pyautogui.press("space"), pyautogui.click(x=cx, y=BTM_Y - 105, interval=execution_time, button="left"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.press("space"), pyautogui.click(x=cx, y=BTM_Y - 105, interval=execution_time, button="right"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.click(x=cx, y=BTM_Y - 105, button="left"), pyautogui.click(x=rand_x, y=rand_y, interval=timeout_delay, button="left"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.click(x=cx, y=BTM_Y - 105, button="left"), pyautogui.click(x=rand_x, y=rand_y, interval=timeout_delay, button="right"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.click(x=cx, y=BTM_Y - 105, button="right"), pyautogui.click(x=rand_x, y=rand_y, interval=timeout_delay, button="right"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.click(x=cx, y=BTM_Y - 105, button="right"), pyautogui.click(x=rand_x, y=rand_y, interval=timeout_delay, button="left"), time.sleep(timeout_delay)) for _ in range(3) ]
                ])
            else:
                action.extend([
                    lambda: [ pyautogui.typewrite(['space'] * 6, interval=execution_time) for _ in range(3) ],
                    ...
                    lambda: [ (pyautogui.press("space"), pyautogui.click(x=cx, y=BTM_Y - 105, interval=execution_time, button="left"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.press("space"), pyautogui.click(x=cx, y=BTM_Y - 105, interval=execution_time, button="right"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.click(x=cx, y=BTM_Y - 105, button="left"), pyautogui.click(x=rand_x, y=rand_y, interval=execution_time, button="left"), time.sleep(timeout_delay)) for _ in range(3) ],
                    lambda: [ (pyautogui.click(x=cx, y=BTM_Y - 105, button="right"), pyautogui.click(x=rand_x, y=rand_y, interval=execution_time, button="right"), time.sleep(timeout_delay)) for _ in range(3) ]
                ]) if not state.spin_btn else \
            action.extend([
                #
            ])
        ...
        #         ])
            ...
            if state.widescreen:
                ...
                if "PP" in provider.get("initial"):                
                    action.extend([
                        lambda: (pyautogui.press('space'), time.sleep(random.uniform(0.05, 0.12)), pyautogui.mouseDown(x=cx, y=BTM_Y - 200, button='left'), time.sleep(10 - (timer().timestamp() % 10)), pyautogui.mouseUp(button='left')),
                        ...
                        # lambda: pyautogui.press('space'),
                        # lambda: (pyautogui.keyDown('space'), pyautogui.keyUp('space')),
                        # lambda: (pyautogui.press('space'), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='left'), time.sleep(10 - (timer().timestamp() % 10)), pyautogui.mouseUp(button='left')),
                        # lambda: (pyautogui.press('space'), pyautogui.mouseDown(x=cx, y=BTM_Y - 105, button='right'), time.sleep(10 - (timer().timestamp() % 10)), pyautogui.mouseUp(button='right'))
                    ]) 
                action.extend([
                    lambda: pyautogui.click(x=cx, y=BTM_Y - 105, button='left'),
                    # lambda: pyautogui.click(x=cx, y=BTM_Y - 105, button='right'),
                ...
                if not alert_queue.empty():
                    ...
                    if sound_file == "ping":
                        ...
                        voice = VOICES["Trinoids"] if (
                            ...
                            "pull_score_spin" in sound_file or "bet max" in sound_file
...
_overlay_order = [ "banner", "hs_data", "api_data", "winners_data" ]  # Fixed redraw order
...
def fetch_api_data():
    ...
    last_jackpot_value = last_10m_value = last_1h_value = last_3h_value = last_6h_value = None
    last_delta_value = last_delta_10m_value = last_delta_1h_value = last_delta_3h_value = last_delta_6h_value = None
    last_api_vol = prev_api_vol = api_vol_avg = api_vol_delta = prev_api_vol_delta = last_api_vol_delta = None
    last_avg_predicted_delta_sec = prev_avg_predicted_delta_sec = None
    last_avg_predicted_delta = prev_avg_predicted_delta = None
    last_avg_volatility_sec = prev_avg_volatility_sec = None
    ...
    while not stop_event.is_set():
        try:
            ...
            if current_jackpot != last_jackpot_value:
                ...
                new_data_seconds = f"{timer().second}.{timer().microsecond // 10000:02d} ms"
            ...
            if ema_api_vol is None:
                ema_api_vol = api_vol
            else:
                ema_api_vol = (
                    EMA_ALPHA * api_vol
                    + (1 - EMA_ALPHA) * ema_api_vol
                )

            api_vol_avg = round(ema_api_vol, 2)
            ...
            avg_volatility = round(ema_volatility, 2)
            # avg_volatility_min = round(ema_volatility_min, 2)
            
            avg_predicted_delta = round(ema_predicted_delta, 2)
            prev_avg_predicted_delta = 0.0 if prev_avg_predicted_delta is None else last_avg_predicted_delta if (avg_predicted_delta != last_avg_predicted_delta) else prev_avg_predicted_delta
            ...
            #     # if state.scatter_mode: break
                ...
                if state.auto_mode and not state.wheel_mode and not state.quick_spin: #and abs(predicted_delta_10m) >= 100:
                    # threading.Thread(target=spin, args=(False, False, True, False,), daemon=True).start()
                    if state.last_spin is not None:                        
                        if not any(
                            spin_type in state.last_spin
                        ...
                        # ]):
                            ...
                            if any(
                                spin_type in state.last_spin
                                for spin_type in ("normal", "spam")
                            ) and (random.random() < 0.4 or prev_api_vol_delta < 0 > api_vol_delta): #reversal auto clear
                                if state.slow_mode:
                                    if any([
                                        # state.hit_win,
                                        abs(api_vol_delta) >= 100,
                        ...
                        if state.slow_mode:
                            if session_mode == "HOT" and any([
                                ...
                                threading.Thread(target=spin, args=(False, False, True, False, False,), daemon=True).start()
                        else:
                            threading.Thread(target=spin, args=(False, False, True, False, False,), daemon=True).start()
            ...
            colored_volatility_sec = f"{colors['BLCYN'] if math.floor(volatility_score) >= round(abs(avg_volatility_sec)) else colors['YEL'] if (abs(avg_volatility_sec) <= 10) else colors['ORA'] if (abs(avg_volatility_sec) >= 80 and abs(avg_volatility_sec) < 100) else colors['RED'] if (abs(avg_volatility_sec) >= 100) else colors['GRE']}{abs(avg_volatility_sec):.2f}{colors['RES']}"
            ...
            volatility_signal = f"{colors['LCYN']}◉{colors['RES']}" if math.floor(volatility_score) >= round(abs(avg_volatility_sec)) else f"{colors['LRED']}⬇{colors['RES']}" if (abs(avg_volatility_sec) < abs(prev_avg_volatility_sec)) else f"{colors['LGRE']}⬆{colors['RES']}" if (abs(avg_volatility_sec) > abs(prev_avg_volatility_sec)) else None
            ...
            predicted_signal = f"{colors['LCYN']}◉{colors['RES']}" if math.floor(abs(predicted_delta_10m)) <= round(abs(avg_predicted_delta_sec)) else f"{colors['LRED']}⬇{colors['RES']}" if (abs(avg_predicted_delta_sec) < abs(prev_avg_predicted_delta_sec)) else f"{colors['LGRE']}⬆{colors['RES']}" if (abs(avg_predicted_delta_sec) > abs(prev_avg_predicted_delta_sec)) else None
            ...
            volume_signal = f"{colors['LCYN']}◉{colors['RES']}" if math.floor(abs(api_vol)) <= round(abs(prev_api_vol)) else f"{colors['LRED']}⬇{colors['RES']}" if (abs(api_vol) < abs(prev_api_vol)) else f"{colors['LGRE']}⬆{colors['RES']}" if (abs(api_vol) > abs(prev_api_vol)) else None
            ...
            colored_api_volume = (
                ...
                colors['BLCYN'] if api_vol >= 60  else
                colors['BLGRE'] if api_vol <= 30  else
                colors['GRE']}"
            ...
            colored_delta_volume_signal = f"{colors['LRED']}▼{colors['RES']}" if (api_vol < prev_api_vol) else f"{colors['LGRE']}▲{colors['RES']}" if (api_vol > prev_api_vol) else f"{colors['LCYN']}◆{colors['RES']}"
            colored_delta_volume = f"{colors['RED'] if (api_vol_delta < 0) else colors['GRE'] if (api_vol_delta > 0) else colors['CYN']}{api_vol_delta:+.2f}{colors['RES']}"
            diff_delta_volume = f"{colors['WHTE']}({colors['LMAG']}Δ{colors['DGRY']}:{colored_delta_volume}{colors['WHTE']}) {colored_delta_volume_signal}"
            colored_volume = f"{colors['WHTE']}Volume{colors['RES']}: {colored_api_volume} {blinking_volume_signal} {diff_delta_volume}"
            ...
            colored_volatility = f"{colors['WHTE']}Volatility 💤{colors['RES']}: {colors['LYEL'] if (volatility_score <= 10) else colors['ORA'] if (volatility_score >= 80 and volatility_score < 100) else colors['LRED'] if (volatility_score >= 100) else colors['LGRE']}{volatility_score:.2f}{colors['RES']} {blinking_volatility_signal} {colored_volatility_sec} {diff_volatility_sec} {colors['WHTE']}Avg{colors['RES']}: {colors['CYN']}{avg_volatility}{colors['RES']}"
            colored_predicted_delta = f"{colors['WHTE']}Predicted {colors['LMAG']} Δ{colors['RES']} : {colors['LYEL'] if (abs(predicted_delta_10m) <= 10) else colors['ORA'] if (abs(predicted_delta_10m) >= 80 and abs(predicted_delta_10m) < 100) else colors['LMAG'] if (abs(predicted_delta_10m) >= 100) else colors['LGRE']}{abs(predicted_delta_10m):.2f}{colors['RES']} {blinking_predicted_signal} {colored_predicted_delta_sec} {diff_predicted_delta_sec} {colors['WHTE']}Avg{colors['RES']}: {colors['CYN']}{abs(avg_predicted_delta)} {diff_delta_avg_predicted_delta}{colors['RES']}"
            ...
            message = (
                f"\n\t🎰 {colors['LMAG']}API Meter{colors['RES']}: {colored_current} {percent} {diff} {api_signal} {colored_delta_shift} {colored_session} {f"{colors['BLNK']}🔥🔥🔥{colors['RES']} {colors['WHTE']}{hot_seconds:.2f}{colors['RES']}" if session_mode == "HOT" else ''}\n"
                f"\n\t{jackpot_bar} {colored_shocked}"
                ...
                f"\n\t{colored_volume} {colors['WHTE']} Avg{colors['RES']}: {api_vol_avg}\t{colors['WHTE']}Avg Data/Sec{colors['RES']}: {colors['CYN']}{new_data_seconds}{colors['RES']}\n"
                f"\n\t{colors['WHTE']}Bet Level{colors['RES']}: {bet_lvl}\t{colors['WHTE']}Last Spin{colors['RES']}: {f'{colors['BRED']}' + state.last_spin.replace('_', ' ').title() + f' {colors['BLNK']}🌀{colors['RES']}' if state.last_spin is not None else ''}\n"
    ...
    while not stop_event.is_set():
        try:
            ...
            for winner in winners_data:
                ...
                if is_current_game: message += f" | {colors['WHTE']}Volume{colors['RES']}: {state.api_vol}"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # 3️⃣ Cleanup Redis
        try:
            r.delete("game", "provider", "url", "api_server", "game_data", "api_data", "winners_data")
            r.close()
        except Exception:
            pass
